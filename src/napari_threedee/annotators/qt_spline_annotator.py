...
class QtFilamentAnnotatorWidget(QtThreeDeeWidgetBase):
    def __init__(self, viewer: napari.Viewer):
        ...
        self.current_spline_index_spinbox.setValue(self.model.active_sphere_id)
        ...
        self.model.events.active_sphere_id.connect(self._update_current_spline_id)
    ...
    def _on_current_filament_id_changed(self, event: Event):
        self.model.active_sphere_id = self.current_spline_index_spinbox.value()
